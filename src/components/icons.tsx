...
const Icons = () => {
    ...
    const iconsAnimation = () => {
        ...
        //sassIcon
        const sassIcon = icons.current?.children[3] as HTMLIFrameElement;
        ...
        //netIcon
        const netIcon = icons.current?.children[4] as HTMLIFrameElement;
        ...
        //nextIcon
        const nextIcon = icons.current?.children[5] as HTMLIFrameElement;
